                    ...
                    {collections.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 p-10 flex flex-col justify-end text-white text-right">
                                <div className="collection-icon hidden lg:flex mb-6 h-16 w-16 bg-white/20 backdrop-blur-md rounded-2xl items-center justify-center group-hover:scale-110 transition-transform duration-500">
                                    {item.icon}
                                </div>
